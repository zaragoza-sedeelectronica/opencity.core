...
public class TransformadorRdf implements TransformadorGenerico {
	...
	public void transformarObjeto(StringBuilder respuesta, Object retorno,
		...
		TransformadorBasicoRdf transNew = new TransformadorBasicoRdf();
		try {
			transNew.transformarObjeto(respuesta, retorno, peticion, primero, prefijo);
		} catch (UnsupportedEncodingException e) {
			throw new InvalidImplementationException("Unsupported encoding", e);
		} catch (NoSuchAlgorithmException e) {
			throw new InvalidImplementationException("no such algorithm", e);
		}
	}
