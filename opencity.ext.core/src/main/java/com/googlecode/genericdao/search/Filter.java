...
public class Filter implements Serializable {
	...
	public static final int OP_DISTANCIA = 14;
	...
	public static final int OP_NONE = 202; /* not SOME */
	...
	public static Filter distancia(double radio, double x, double y) {
		return new Filter("distancia", new double[]{radio, x, y}, OP_DISTANCIA);
	}
